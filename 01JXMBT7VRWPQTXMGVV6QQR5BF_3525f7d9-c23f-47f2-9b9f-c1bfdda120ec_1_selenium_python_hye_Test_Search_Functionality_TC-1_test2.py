...
try:
    ...
    # Step - 1 : go to url 'https://ecommerce-playground.lambdatest.io/'
    driver.get("https://ecommerce-playground.lambdatest.io/")
    driver.implicitly_wait(6)

    # Step - 2 : get the visibility of search functionality on the home page
    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 3 : assert the search functionality is present on the home page
    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 4 : Type 'Apple' in the search input field
